...
export default function Hero() {
  return (
    <section className="mx-auto flex min-h-[200vh] max-w-7xl flex-col items-center gap-10 px-4 pb-24 pt-6 sm:px-8 sm:pb-24 sm:pt-10 md:min-h-[82vh] md:flex-row md:items-center">
